...
export var clearButton = document.getElementById("clearButton");
...
export var locationUpdateLog = document.getElementById("locationUpdateLog");
...
allBackgroundMusic = {
	...
	Rain: new Howl({
		src: ["assets/sounds/background_music/rain.wav"],
		volume: 0.1,
		loop: true,
	}),
	Lofi: new Howl({
		src: ["assets/sounds/background_music/lofi.mp3"],
		volume: 0.3,
		loop: true,
	}),
};
...
const backgroundMusicSelect = document.getElementById('backgroundMusicOptions');
backgroundMusicSelect.addEventListener('change', function() {
  const selectedMusic = backgroundMusicSelect.value;

 // change the background image based on the selected music
 const body = document.getElementsByTagName('body')[0];
 switch (selectedMusic) {
   case 'Rain':
	$("#mainPage").css("background-image","url(assets/images/rain.jpg)");
	$("#mainPage").css("background-size","cover");
	$(".radial-progress-bar .overlay").css("background","#B9B3A7");
	 break;
   case 'Ocean':
	$("#mainPage").css("background-image","url(assets/images/ocean.jpg)");
	$("#mainPage").css("background-size","cover");
	$(".radial-progress-bar .overlay").css("background","#B9B3A7");
	 break;
   case 'Forest':
	$("#mainPage").css("background-image","url(assets/images/forest.jpg)");
	$("#mainPage").css("background-size","cover");
	$(".radial-progress-bar .overlay").css("background","#B9B3A7");
		 break;
   case 'Campfire':
	$("#mainPage").css("background-image","url(assets/images/campfire.jpg)");
	$("#mainPage").css("background-size","cover");
	$(".radial-progress-bar .overlay").css("background","#B9B3A7");
		 break;
   case 'Lofi':
	$("#mainPage").css("background-image","url(assets/images/lofi.jpg)");
	$("#mainPage").css("background-size","cover");
	$(".radial-progress-bar .overlay").css("background","#B9B3A7");
		 break;
   default:
	 body.style.backgroundImage = 'none';
	 $("#mainPage").css("background-image","url(https://images.unsplash.com/photo-1474540412665-1cdae210ae6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2FsbXxlbnwwfHwwfHw%3D&w=1000&q=80)");
	 break;
 }
});
...
function darkMode() {
	$(document.body).css("background-color", "#07080a");
	$("#mainPage").css("background-image","url(night.jpg)");
    $("#mainPage").css("background-size","cover");
	$(".bg-light").toggleClass("darkMode");
	$("#brandName").css("color", "#ececec");
	$("#timeLeft").css("color", "#ececec");
	$(".overlay").css("background", "##07080a");
...
function lightMode() {
	$(document.body).css("background-color", "#F9E3CB");
	$("#mainPage").css("background-image","url(https://images.unsplash.com/photo-1474540412665-1cdae210ae6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2FsbXxlbnwwfHwwfHw%3D&w=1000&q=80)");
	$(".bg-light").toggleClass("darkMode");
	$("#brandName").css("color", "black");
	$("#timeLeft").css("color", "black");
	$(".overlay").css("background", "#F9E3CB");
	$("#startButton, #stopButton, #resetButton").css("box-shadow", "0 9px #999");
	$(".modal-content").css("background-color", "#F9E3CB");
...
// downloadLink.setAttribute("href", "data:text/csv;charset=utf-8," + encodeURIComponent(localStorage.logContents));
